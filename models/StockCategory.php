...
class StockCategory extends BaseModel
{
    ...
    public function loadData()
    {
        try{
            ...
            $query = "SELECT * FROM StockCategoryDataBase";
    ...
    public function all()
    {
        $query = "SELECT * FROM stock_categories";
    ...
    {
        $query = "SELECT * FROM stock_categories WHERE master_id=:masterid";
        $stmt = $this->con->prepare($query);
    ...
    public function add($data)
    {
        ...
        if (!empty($data) && is_array($data)) {
            ...
            $this->batchInsert('stock_categories', array_values($data), $columns);
    ...
    public function update($data, $master_id)
    {
        if (!empty($data) && is_array($data)) {
            ...
            $query = "UPDATE stock_categories SET $update_query WHERE master_id=$master_id";
            $stmt = $this->con->prepare($query);
            $stmt->execute();
            return true;
        } else {
